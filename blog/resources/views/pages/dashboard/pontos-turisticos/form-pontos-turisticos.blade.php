      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <br />
              <form class="form-horizontal form-label-left" method="POST" action="{{URL::to('/store-pontos-atrativos')}}" enctype="multipart/form-data">
                <h5 class="text-uppercase text-center">Dados Pontos Turisticos</h5>
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nome">Nome<span class="required">*</span>
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="nome" required="required" class="form-control col-md-7 col-xs-12" name="nome"  maxlength = "100">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="endereco" required="required" class="form-control col-md-7 col-xs-12" name="endereco" maxlength = "100">
                  </div>
                </div>
                <div class="form-group">
