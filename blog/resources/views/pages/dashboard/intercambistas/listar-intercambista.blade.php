              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a data-toggle="modal" data-target="#confirmarExcluirModal"  title="Excluir Intercambista"><i class="fa fa-times"></i></a>
                    <!-- Modal -->
                    <div class="modal fade" id="confirmarExcluirModal" tabindex="-1" role="dialog" aria-labelledby="confirmarExcluirModalTitle" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="confirmarExcluirModalTitle">
                          ...
                          <div class="modal-body">
                            Você deseja mesmo excluir o(a) intercambista: {{$intercambista->nome}}
                          </div>
