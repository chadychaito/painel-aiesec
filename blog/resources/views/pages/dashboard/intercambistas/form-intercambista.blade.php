      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <br />
              <form class="form-horizontal form-label-left" method="POST" action="{{URL::to('/store_intercambista')}}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="nomeCompleto" id="nomeCompleto" maxlength = "100">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="passport" required="required" class="form-control col-md-7 col-xs-12" name="numPassaporte" id="numPassaporte" maxlength = "14">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-12">
                    <input type="date" id="birthday" class="date-picker form-control col-md-7 col-xs-12" required="required" type="text" name="dataNascimento" id="dataNascimento">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="tel" id="telefone" required="required" data-inputmask="'mask' : '+999999999-9999'" class="form-control col-md-7 col-xs-12" name="numTelefone" id="numTelefone">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="buddy" name="buddy" class="form-control col-md-7 col-xs-12" maxlength = "14" required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="host" required="required" class="form-control col-md-7 col-xs-12" name="nomeHost" id="nomeHost" maxlength = "14">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="projeto"  name="projeto" class="form-control col-md-7 col-xs-12" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-3">Data Início</label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="date" type="text" class="form-control" name="dataInicio" id="dataInicio">
                  </div>
                </div>
