            ...
            <table id="datatable" class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="/editar-projetos?id={{$projeto->id}}" title="Editar Intercambista"><i class="fa fa-wrench"></i></a>
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            Você deseja mesmo excluir o projeto <b>{{$projeto->nome}}</b> com CNPJ <b>{{$projeto->cnpj}}</b>
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                            <a href="/remover-projetos?id={{$projeto->id}}">
