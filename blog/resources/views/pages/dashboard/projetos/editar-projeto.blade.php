              ...
              <form class="form-horizontal form-label-left" method="POST" action="{{URL::to('/update-projetos')}}?id={{$projeto->id}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="cnpj" required="required" class="form-control col-md-7 col-xs-12" name="cnpj" data-inputmask="'mask' : '99.999.999/9999-99'" value="{{$projeto->cnpj}}">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="nome" required="required" class="form-control col-md-7 col-xs-12" name="nome" value="{{$projeto->nome}}">
                  </div>
                </div>
                <div class="form-group">
